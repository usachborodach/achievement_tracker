...
ln -s /root/achievement_tracker/systemd.conf /etc/systemd/system/achievement_tracker.service
systemctl daemon-reload
systemctl enable --now achievement_tracker

# nginx config file symlink
ln -s /root/achievement_tracker/nginx.conf /etc/nginx/sites-enabled/achievement_tracker
nginx -t
